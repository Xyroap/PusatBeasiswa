...
<head>
    ...
    <title>PusatBeasiswa Workshop</title>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <section class="hero-banner">
                <img src="{{ asset('images/image 33.png')}}" alt="Hero Image">
            </section>

            <section class="workshop-container">
                <div class="workshop">
                    <h1 class="section-title">Workshop</h1>
                    <h2 class="section-label">Discover and join interesting activities!</h2>
                    
                    <form action="{{ route('workshop') }}" method="GET" class="search-bar">
                    ...
                    <div class="workshops-grid">
                        @foreach($workshops as $workshop)
                            <a href="{{ route('workshop.show', $workshop) }}" class="workshop-card-link">
                                <div class="workshop-card">
                                    <div class="workshop-image" style="background-image: url('{{ asset('images/' . $workshop->image) }}');"></div>
                                    ...
                                    <div class="workshop-content">
                                        ...
                                        <div class="author">
                                            ...
                                            <div class="author-name">{{ $workshop->speaker }}</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
