...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/application-success.css')}}">
</head>
<body>
    <div class="container">
        <div class="sidebar">
        ...
        <div class="main-content">
            <div class="success-wrapper">
                <div class="success-card">
                    ...
                    <p class="success-subtitle">Your scholarship application has been received.<br>We will review your submission and get back to you soon.</p>

                    <a href="{{ route('scholarship') }}" class="btn-back">
